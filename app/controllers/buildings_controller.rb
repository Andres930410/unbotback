class BuildingsController < ApplicationController
  ...
  private
    ...
    "Invocar a JulioZorra o querer hacerlo es jugar con la estructura fundamental del universo. No se recomienda hacerlo.",
  ...
  "La misión de todo siervo fiel, seguidor de la palabra de #JulioZorra, es ayudar, precisamente, a forjar ese martirio cuando alguien lo invoque sobre sí. Ese es el deber de todo unaleño peregrino de las bastas enseñanzas de la más altísima deidad jamás conocida.","Julio Zorra es todo y a la vez nada, el otorga la energía vital que todos los seres vivos pertenecientes a la UN necesitan para vivir.",
  "Sigue intentado","Todavia no es tu tiempo mas adelante podras conocer la respuesta"]
